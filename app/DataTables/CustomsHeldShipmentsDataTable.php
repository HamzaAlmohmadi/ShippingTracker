...
use App\Models\CustomsHeldShipment;
...
class CustomsHeldShipmentsDataTable extends DataTable
{
            ...
            ->addColumn('status', function ($query) {
                ...
                switch ($status) {
                    ...
                    case 'in_transit':
                        ...
                        break;
                    case 'customs_held':
                        $badgeColor = 'bg-red'; // لون مختلف للشحنات المحتجزة
                        break;
                    case 'delivered':
    ...
    {
        return $model->where('status', 'customs_held')->newQuery(); // عرض الشحنات المحتجزة فقط
    }
    ...
    {
        return $this->builder()
            ->setTableId('customsheldshipments-table')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('estimated_release')->title('تاريخ متوقع الإفراج')->addClass('text-center'),
