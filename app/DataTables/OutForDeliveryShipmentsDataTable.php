...
use App\Models\OutForDeliveryShipment;
...
class OutForDeliveryShipmentsDataTable extends DataTable
{
            ...
            ->addColumn('status', function ($query) {
                ...
                switch ($status) {
                    ...
                    case 'out_for_delivery':
                        $badgeColor = 'bg-success'; // لون مختلف للشحنات في مرحلة التسليم
                        break;
                    case 'delivered':
    ...
    {
        return $model->where('status', 'out_for_delivery')->newQuery(); // عرض الشحنات في مرحلة التسليم فقط
    }
    ...
    {
        return $this->builder()
            ->setTableId('outfordeliveryshipments-table')
    ...
    {
        return 'OutForDeliveryShipments_' . date('YmdHis');
    }
}
