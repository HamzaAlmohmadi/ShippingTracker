...
<div class="dashboard_sidebar">
    ...
    <a href="javascript:;" class="dash_logo"><img src="{{asset('frontend/images/DHL3.jpg')}}" alt="logo" class="img-fluid" style="width: 200px; height: 100px"></a>
    ...
    <ul class="dashboard_link">
      <li><a class="#" href="{{route('dashboard.driver')}}"><i class="fas fa-tachometer"></i>لوحة التحكم</a></li>

      <li><a href="{{route('profile.index')}}"><i class="fas fa-user"></i> ملف شخصي</a></li>
      <li>

        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <a href="{{route('logout')}}" onclick="event.preventDefault();
            this.closest('form').submit();"><i class="far fa-sign-out-alt"></i> تسجيل خروج</a>
        </form>
      </li>
    </ul>
  </div>
