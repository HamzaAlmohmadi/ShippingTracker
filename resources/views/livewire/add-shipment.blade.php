...
<div>
    ...
    <div>
        @include('livewire.Sender_Receiver_From')

        @include('livewire.shipment_from')
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                {{-- @if ($updateMode)
                        ...
                        @else --}}
                <button class="btn btn-success btn-sm btn-lg pull-right" wire:click="saveShipment" type="button">التالي
                </button>
                {{-- @endif --}}
            </div>
        </div>
