                    ...
                    <div class="col-xl-5 col-md-10 col-lg-8 m-auto">
                        <form class="track_form" action="{{ route('user.shipment-tracking.track') }}" method="GET">
                            ...
                            <div class="wsus__track_input">
                                ...
                                <input type="text" placeholder="EX: 123456789" name="tracker" required>
                            </div>
    ...
    <section id="wsus__tracking">
        <div class="container">
            <div class="wsus__track_area">
                <div class="row">
                    <div class="col-xl-5 col-md-10 col-lg-8 m-auto">
                        <form class="track_form" action="#" method="GET">
                            <h4 class="text-center">📦 تتبع الشحنة</h4>
                            <p class="text-center">أدخل رقم التتبع لمعرفة حالة الشحنة</p>
                            <div class="wsus__track_input">
                                <label class="d-block mb-2">رقم التتبع *</label>
...
@section('content')
    ...
    <div class="page-title dark-background" data-aos="fade"
        ...
        <div class="container position-relative">
            ...
            <p>🚚 تتبع شحناتك بسهولة وأمان! أدخل رقم التتبع الخاص بك لمعرفة حالة الشحنة الحالية.</p>
            <nav class="breadcrumbs">
                <ol>
                    <li><a href="/">🏠 الرئيسية</a></li>
                    <li class="current">📦 تتبع الشحنات</li>
                </ol>
            </nav>
        </div>
    </div><!-- End Page Title -->
    <section id="wsus__tracking">
        <div class="container">
            <div class="wsus__track_area">
                <div class="row">
                    <div class="col-xl-5 col-md-10 col-lg-8 m-auto">
                        <form class="track_form" action="{{ route('shipment-tracking') }}" method="GET">
                            <h4 class="text-center">📦 تتبع الشحنة</h4>
                            <p class="text-center">أدخل رقم التتبع لمعرفة حالة الشحنة</p>
                            <div class="wsus__track_input">
                                <label class="d-block mb-2">رقم التتبع *</label>
                                {{-- <input type="text" class="form-control" placeholder="أدخل رقم التتبع، مثال: 123456789" name="tracker" required> --}}
                                <input type="text" placeholder="EX: 123456789" name="tracker" value="{{ $tracker }}" required>
                            </div>
                            <button type="submit" class="common_btn">🔍 تتبع</button>
                        </form>
                    </div>
