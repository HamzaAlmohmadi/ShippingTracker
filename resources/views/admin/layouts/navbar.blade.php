...
<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <form class="form-inline {{ app()->getLocale() == 'ar' ? 'ml-auto' : 'mr-auto' }}">
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown"
                ...
                <img alt="image" style="width: 40px;height: 40px; object-fit: cover;" src="{{ URL::asset('backend/images/yeman.png') }}"
